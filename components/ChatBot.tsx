...
import { createChatSession, ChatSession } from '../services/aiProvider';
    ...
    const initializeChat = async () => {
      try {
        ...
        setMessages([{
          id: Date.now(),
          sender: 'ai',
          text: "Hello! How can I help you with your vehicle today? You can ask me about maintenance, repairs, or finding local shops."
        }]);
