...
import { generateReportSummary } from '../services/aiProvider';
  ...
  useEffect(() => {
    const generateReport = async () => {
      try {
        ...
        // A more robust implementation would transform the checklist into a structured format.
        // For this project, we're focusing on the AI summary and external data.
        ...
        await offlineService.saveReport(newReport, user?.id);
